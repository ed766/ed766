...
| [AXI4 L1 Cache DV](https://github.com/ed766/AXI4-L1-Cache-DV) | Cache microarchitecture, C++ replay, SECDED RAS, bounded MSI, SRAM BIST | `22 / 22` directed; `127 / 127` replay; `25 / 25` MSI seeds; `2 / 2` integrated BIST | [Metrics](https://github.com/ed766/AXI4-L1-Cache-DV/blob/main/docs/project_metrics.md) · [CI](https://github.com/ed766/AXI4-L1-Cache-DV/actions) · [v0.4.0](https://github.com/ed766/AXI4-L1-Cache-DV/releases/tag/v0.4.0) |
...
| [INT8 Tensor Accelerator DV](https://github.com/ed766/INT8-Tensor-Accelerator-DV) | PyTorch-to-RTL checking, quantization, AXI integration, RV32I offload | `130 / 130` exact comparisons; `40 / 40` benchmark; `25 / 25` correctness; `5 / 5` mutations | [Metrics](https://github.com/ed766/INT8-Tensor-Accelerator-DV/blob/main/docs/project_metrics.md) · [CI](https://github.com/ed766/INT8-Tensor-Accelerator-DV/actions) · [v0.3.0](https://github.com/ed766/INT8-Tensor-Accelerator-DV/releases/tag/v0.3.0) |
