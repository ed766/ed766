...
| [INT8 Tensor Accelerator DV](https://github.com/ed766/INT8-Tensor-Accelerator-DV) | PyTorch-to-RTL checking, quantization, AXI integration, RV32I offload | `130 / 130` exact comparisons; `40 / 40` benchmark; `25 / 25` correctness; `5 / 5` mutations | [Metrics](https://github.com/ed766/INT8-Tensor-Accelerator-DV/blob/main/docs/project_metrics.md) · [CI](https://github.com/ed766/INT8-Tensor-Accelerator-DV/actions) · [v0.3.1](https://github.com/ed766/INT8-Tensor-Accelerator-DV/releases/tag/v0.3.1) |
