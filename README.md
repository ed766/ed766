...
| [AXI4 L1 Cache DV](https://github.com/ed766/AXI4-L1-Cache-DV) | Cache microarchitecture, C++ replay, SECDED RAS, MSI coherence, RVWMO litmus checking | `22 / 22` directed; `127 / 127` replay; `400 / 400` RTL litmus schedules; `17 / 17` coherent RTL mutations | [Metrics](https://github.com/ed766/AXI4-L1-Cache-DV/blob/main/docs/project_metrics.md) · [CI](https://github.com/ed766/AXI4-L1-Cache-DV/actions) · [v0.6.0](https://github.com/ed766/AXI4-L1-Cache-DV/releases/tag/v0.6.0) |
